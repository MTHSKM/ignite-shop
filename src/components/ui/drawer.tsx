  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ref={ref}
        style={{ backgroundColor: '#202024', borderColor: '#202024' }}
        className={cn(
          "fixed z-50 flex h-auto flex-col rounded-t-[10px] border",
          (!direction || direction === 'bottom') && "inset-x-0 bottom-0 mt-24",
          direction === 'right' && "top-0 right-0 w-screen max-w-[480px] h-full",
          className
        )}
        {...props}
      >
